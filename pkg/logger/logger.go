...
func setLogConfig() {
	...
	hook := lumberjack.Logger{
		Filename:   conf.LogConf.FileName,   // 日志文件路径
		MaxSize:    conf.LogConf.MaxSize,    // 每个日志文件保存的最大尺寸 单位：M
		MaxBackups: conf.LogConf.MaxBackups, // 日志文件最多保存多少个备份
		MaxAge:     conf.LogConf.MaxAge,     // 文件最多保存多少天
		Compress:   conf.LogConf.Compress,   // 是否压缩
	}
